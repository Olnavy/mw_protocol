...
for experiment in experiments:
    ...
    ds_routed = xr.open_dataset(
        f"/nfs/see-fs-01_users/eeymr/work/outputs/proj_glac_mw/glac.-21_0_500.diff/{experiment}.discharge.glac_mw.nc",
        decode_times=False)
    saving.to_waterfix(ds_routed, ds_wfix)
    
    ds_spreaded = xr.open_dataset(
        f"/nfs/see-fs-01_users/eeymr/work/outputs/proj_glac_mw/glac.-21_0_500.diff_s/{experiment}.discharge.glac_mw.nc",
        decode_times=False)
