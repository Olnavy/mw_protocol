...
# --------------------------------------------------------- #
# Objective: Create and saved routted mask between -26 and 0.
# --------------------------------------------------------- #
...
plotting.flux_ts("dif", -26, 0, False,
                 f"/nfs/annie/eeymr/work/outputs/Proj_GLAC1D/dif_-26_0/teadv3.qrparm.GLAC1D_DEGLAC.nc")
